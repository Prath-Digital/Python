...
1. Clone the repository:
   ```bash
   git clone https://github.com/Prath-Digital/Python.git
   ```
...
<table style="width:100%;border-collapse:collapse;font-family:'cascadia code','Segoe UI',Arial,sans-serif;">
  ...
  <tbody>
    ...
    <tr style="background:#222;color:#fff;">
      ...
      <td style="padding:10px 8px;border:2px solid #fff;"><b>Exception And File Handling</b></td>
    </tr>
    <tr style="background:#fff;color:#000;">
      <td style="padding:10px 8px;border:2px solid #000;">11.1</td>
      <td style="padding:10px 8px;border:2px solid #000;">
        <ul style="margin:0;padding-left:18px;">
          <li><span style="color:#d32f2f;">Text File Handling</span></li>
    ...
    <tr><td colspan="2" style="background:#000;"><hr style="border:1px solid #fff;"></td></tr>
    <tr style="background:#222;color:#fff;">
      <td style="padding:10px 8px;border:2px solid #fff;">13</td>
      <td style="padding:10px 8px;border:2px solid #fff;"><b>Modules And Packages</b></td>
    </tr>
    <tr style="background:#fff; color:#000;">
      <td style="padding:10px 8px;border:2px solid #000;">13.1</td>
      <td style="padding:10px 8px;border:2px solid #000;">
        <ul style="margin:0;padding-left:18px;">
          <li><span style="color:#d32f2f;">Datetime Module</span></li>
    ...
    <tr style="background:#222;color:#fff;">
      <td style="padding:10px 8px;border:2px solid #fff;">13.2</td>
      <td style="padding:10px 8px;border:2px solid #fff;">
        <ul style="margin:0;padding-left:18px;">
          <li><span style="color:#d32f2f;">Random Module</span></li>
    ...
    <tr style="background:#222;color:#fff;">
      <td style="padding:10px 8px;border:2px solid #fff;">16.4</td>
      <td style="padding:10px 8px;border:2px solid #fff;">
        <ul style="margin:0;padding-left:18px;">
          <li><span style="color:#d32f2f;">Introduction to Pandas</span></li>
          <li><span style="color:#1976d2;">Series & DataFrame</span></li>
    ...
    <tr style="background:#222;color:#fff;">
      <td style="padding:10px 8px;border:2px solid #fff;">18.2</td>
      <td style="padding:10px 8px;border:2px solid #fff;">
        <ul style="margin:0;padding-left:18px;">
    ...
    <tr style="background:#fff;color:#000;">
      <td style="padding:10px 8px;border:2px solid #000;">18.3</td>
      <td style="padding:10px 8px;border:2px solid #000;">
          <span style="color:#d32f2f;">Data Visualization in Seaborn</span>
          <br>
    ...
    <tr style="background:#fff;color:#000;">
      ...
      <td style="padding:10px 8px;border:2px solid #000;">
        ...
        <span style="color:#fff;background:#3b10a2;padding:2px 6px;border-radius:4px;margin-left:8px;"><a style="color:#fff;text-decoration:none;" href="./Project/Live Project - 2/">Live Project - 2</a></span>
        <br>
        <span style="color:#222;font-weight:bold;display:inline-block;margin-top:8px;margin-left:8px;">
          <img src="https://img.icons8.com/ios-filled/16/000000/settings.png" style="vertical-align:middle;margin-right:4px;">
          PR. 9 Visualizer
    ...
    <tr><td colspan="2" style="background:#000;"><hr style="border:1px solid #fff;"></td></tr>
    <tr style="background:#222;color:#fff;">
      <td style="padding:10px 8px;border:2px solid #fff;">19</td>
      <td style="padding:10px 8px;border:2px solid #fff;"><b>PR. 9 Visualizer</b></td>
    </tr>
    <tr style="background:#fff;color:#000;">
      <td style="padding:10px 8px;border:2px solid #000;">19.1</td>
      <td style="padding:10px 8px;border:2px solid #000;">
        <ul style="margin:0;padding-left:18px;">
          <li><span style="color:#d32f2f;"><img src="https://img.icons8.com/ios-filled/16/ff0000/settings.png" style="vertical-align:middle;margin-right:4px;">Submission Of PR. 9 Visualizer</span></li>
        </ul>
        <span style="color:#fff;background:#7b1fa2;padding:2px 6px;border-radius:4px;"><a style="color:#fff;text-decoration:none;" href="https://github.com/Prath-Digital/Python_PR.-9-Visualizer" target="_blank">Code</a></span>
      </td>
    </tr>
    <tr><td colspan="2" style="background:#000;"><hr style="border:1px solid #fff;"></td></tr>
    <tr style="background:#222;color:#fff;">
      <td style="padding:10px 8px;border:2px solid #fff;">20</td>
      <td style="padding:10px 8px;border:2px solid #fff;"><b>Revision</b></td>
    </tr>
    <tr style="background:#fff;color:#000;">
      <td style="padding:10px 8px;border:2px solid #000;">20.1</td>
      <td style="padding:10px 8px;border:2px solid #000;">
        <ul style="margin:0;padding-left:18px;">
    ...
    <tr style="background:#222;color:#fff;">
      <td style="padding:10px 8px;border:2px solid #fff;">20.2</td>
      <td style="padding:10px 8px;border:2px solid #fff;">
        <ul style="margin:0;padding-left:18px;">
    ...
    <tr style="background:#fff;color:#000;">
      <td style="padding:10px 8px;border:2px solid #000;">20.3</td>
      <td style="padding:10px 8px;border:2px solid #000;">
      <ul style="margin:0;padding-left:18px;">
          <li><span style="color:#d32f2f;">Revision Day - 3</span></li>
        </ul>
      </td>
    </tr>
    <tr><td colspan="2" style="background:#000;"><hr style="border:1px solid #fff;"></td></tr>
    <tr style="background:#222;color:#fff;">
      <td style="padding:10px 8px;border:2px solid #fff;">21</td>
      <td style="padding:10px 8px;border:2px solid #fff;"><b>PR. Final Project</b></td>
    </tr>
    <tr style="background:#fff;color:#000;">
      <td style="padding:10px 8px;border:2px solid #000;">21.1</td>
      <td style="padding:10px 8px;border:2px solid #000;">
        <ul style="margin:0;padding-left:18px;">
        ...
        <span style="color:#fff;background:#7b1fa2;padding:2px 6px;border-radius:4px;"><a style="color:#fff;text-decoration:none;" href="https://github.com/Prath-Digital/Python_PR.-Final-Project" target="_blank">Code</a></span>
      </td>
    </tr>
  </tbody>
  </table>
